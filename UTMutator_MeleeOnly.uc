...
class UTMutator_MeleeOnly extends UTMutator;
...
function InitMutator(string Options, out string ErrorMessage) //grabbed from instagib
{
	if ( UTGame(WorldInfo.Game) != None )
	{
		...
		UTGame(WorldInfo.Game).DefaultInventory[0] = class'UTCQC.CQC_ShockStaff';
                UTGame(WorldInfo.Game).DefaultInventory[1] = class'UTCQC.CQC_Fafnir';
                UTGame(WorldInfo.Game).DefaultInventory[2] = class'UTCQC.CQC_Machette';
...
/*   Begin Object Class=SpriteComponent Name=Sprite ObjName=Sprite Archetype=SpriteComponent'UTGame.Default__UTMutator:Sprite'
   ...
   End Object*/
   Components(0)=Sprite
   Name="Default__UTMutator_MeleeOnly"
